...
<div class="feature-container clearfix">
      <div class="feature-wrapper">
        ...
        <div class="feature-desc feature-desc-1">
          ...
          <ul>
            <li><a href="<?php echo url('/services/1'); ?>#Gemomao"><span class="feature-text">What is a GEMO and when to use it?</span><span class="feature-icon"><i class="fa fa-angle-right"></i></span></a></li>
<!--             <li><a href="<?php echo url('/services/1'); ?>#foreign"><span class="feature-text">When to use GEMO?<span class="feature-icon"><i class="fa fa-angle-right"></i></span></span></a></li> -->
        ...
        <div class="feature-desc feature-desc-2">
          <div class="feature-desc-inner-wrapper">
          <h3><span>Diabetes Care Programme</span></h3>
          <ul>
            <li><a href="<?php echo url('/services/2'); ?>#pressure"><span class="feature-text"><span class="special-text">Diabetes Care Programme</span><span class="feature-icon"><i class="fa fa-angle-right"></i></span></span></a></li>
          </ul>
        </div>
        </div>
      </div>
