...
<div class="mobile-form-outter-wrapper">
    <div class="mobile-form-wrapper">
        ...
        <div class="m-form-choice-wrapper">
            ...
            <a type="button" class="btn m-btn-medical <?php echo $sl['mobile_style']; ?>" href="<?php echo url('/Allianz/DCP/mobile_form/'.$sl['id']); ?><?php echo $sl['m_id_name']; ?>"><?php echo $sl['typeename']; ?></a> <?php endif; endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </div>
</div>
<!--登录-->
            ...
            <form autocomplete="off" class="medical-form form-horizontal" role="form" method="post">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group date-select">
                        ...
                        <div class="col-xs-8 col-sm-9">
                            <input type="text" class="form-control" id="patient-birth" name="birthday" data-field="date" readonly="" value="">
                        </div>
                    </div>
                        ...
                        <div class="col-xs-8 col-sm-9">
                            <div class="col-xs-6 col-sm-4 gender-single">
                                <label for="patient-gender1">
                                    <input type="radio" name="sex" id="patient-gender1" value="1"><span>Male</span></label>
                            </div>
                            <div class="col-xs-6 col-sm-4 gender-single">
                ...
                <div class="form-section">
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-12 control-label medical-label change-label">I glve permission to Allianz Malaysia to release my medival records to Advance Medical</label>
                    </div>
                    <div class="form-group">
                ...
                <div class="checkbox-wrapper">
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <label for="contract-checkbox">I have already read and accept the consent terms</label><span class="contract-click">&nbsp;terms and conditions</span>
                        </div>
                    </div>
                </div>
