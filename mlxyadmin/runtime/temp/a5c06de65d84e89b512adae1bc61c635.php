...
<div class="feature-container clearfix">
        ...
        <div class="feature-desc feature-desc-2">
          ...
          <ul>
            <li><a href="<?php echo url('/Allianz/DCP/services/2'); ?>#pressure"><span class="feature-text"><span class="special-text">Diabetes Care Programme</span><span class="feature-icon"><i class="fa fa-angle-right"></i></span></span></a></li>
          </ul>
        </div>
        </div>
      </div>
