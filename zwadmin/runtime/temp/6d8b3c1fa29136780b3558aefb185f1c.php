<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"D:\www\mlxyadmin\application\emo\view\index\mobile_form.html";i:1517472451;}*/ ?>
<!doctype html>
<html lang="">
<head>
  <meta charset="utf-8">
  ...
  <div id="page-wrapper">
    <div class="form-wrapper">
      <div class="mobile-form-logo-header">
        <a class="logo-wrapper visible-xs clearfix" href="<?php echo url('/Allianz/emo'); ?>">
...
<!--                 <div class="col-xs-4 col-sm-4 address-choose">
        ...
        <div class="form-navigation clearfix">
          <a type="button" class="back-to-home btn btn-navigate pull-left" href="<?php echo url('/Allianz/emo'); ?>">Return</a>
    ...
    <div class="form-feedback-wrapper">
      <div class="form-feedback">
        ...
        <a class="btn form-feedback-btn" href="<?php echo url('/Allianz/emo'); ?>">Return to Main Page</a>
