<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"D:\www\mlxyadmin\application\advance\view\index\mobile_form.html";i:1511766286;}*/ ?>
<!doctype html>
<html lang="">
<head>
  <meta charset="utf-8">
    ...
    <div class="form-wrapper">
      ...
      <form class="medical-form  form-horizontal" role="form">
        ...
        <div class="form-section">
          ...
          <div class="form-group">
            <label for="other-relation" class="col-xs-5 col-sm-4 control-label medical-label">Your relation with the patient
</label>
...
<!--                 <div class="col-xs-4 col-sm-4 address-choose">
          ...
          <div class="form-group">
            <label for="user-email" class="col-xs-5 col-sm-4 control-label medical-label"><span class="has-width"><span class="little-character">Email</span></span></label>
            <div class="col-xs-7 col-sm-8">
