<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"D:\www\mlxyadmin\application\emo\view\index\service_details.html";i:1516609378;s:54:"D:\www\mlxyadmin\application\emo\view\common\base.html";i:1517472451;s:56:"D:\www\mlxyadmin\application\emo\view\common\header.html";i:1515477549;s:56:"D:\www\mlxyadmin\application\emo\view\common\footer.html";i:1517386256;}*/ ?>
<!doctype html>
<html lang="">
<head>
  <meta charset="utf-8">
        ...
        <div class="expert-sub expert-sub-2">
          ...
          <div class="expert-main-example">
            ...
            <div class="expert-info-wrapper">
              ...
              <span class="expert-info" style="text-align:center; ">Clinical Professor of Medicine, Harvard Medical School </span>
            </div>
          </div>
        </div>
        ...
        <div class="diagnose-process-wrapper2 clearfix">
            ...
            <div class="step-wrapper">
              ...
              <div class="diagnose-step-context">
                <div class="diagnose-step-text">
                  <span class="step-title" style="font-weight: bolder;">Scenarios for EMO service</span>
                  <span class="step-title">Example cases for Second Expert Medical Opinion services: </span>
                  <ul style="padding-left: 15px;">
                    <li>When you want to validate and confirm the diagnosis received</li>
                    <li>When diagnosed with critical illness such as cancer, heart disease, and you’d like to understand treatment alternatives
</li>
                    <li>When suggested surgery, and you’d like to reconfirm to make better decisions</li>
                    <li>When receiving contradictory diagnosis from different doctors
</li>
                  </ul>
                </div>
              </div>
          ...
          <div class="diagnose-step">
            <div class="step-wrapper">
              ...
              <div class="diagnose-step-context">
                <div class="diagnose-step-text">
                  <span class="step-title" style="font-weight: bolder;">Scenarios not fit for EMO service
</span>
                  <span class="step-title">These cases are not recommended for Second Expert Medical Opinion services:   
</span>
                  <ul style="padding-left: 15px;">
                    <li>Emergency</li>
                    <li>Accidents</li>
                    <li>In a urgent life threatening situation, such as ICU, with unstable vital signs</li>
                    <li>Daily common issues, such as flu, fever, headache, occasional rash
</li>
